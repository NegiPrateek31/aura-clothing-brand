...
const About = () => (
    <div className="about-page fade-in">
        <SEO
            title="About Negi Clothing - Our Story & Vision"
            description="Learn about Negi Clothing's journey, mission, and commitment to delivering premium fashion and unique streetwear designs."
            path="/about"
